...
function Card1(props) {
  return (
    <div className="container h-[290px] w-[270px]  border-gray-800 shadow-2xl bg-[#F2F2F6] text-center space-y-4 p-4 rounded-2xl hover:scale-105 transition-all duration-300">
